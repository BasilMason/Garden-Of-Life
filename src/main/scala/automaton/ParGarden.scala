...
case class ParGarden(init: List[State], x: Int, y: Int, z: Int) extends Automaton with BasicGarden {
  ...
  private val cells: List[Cell] = init.map(s => s match {
    ...
    case FlowerState(s, w, sn, wa, g, v) => FlowerCell(wind = w, water = wa, sun = sn, gravity = g, velocity = v)
  ...
  private def addCellNeighbour(site: String, c: Cell, n: Cell): Cell = c match {
    ...
    case FlowerCell(i, nei, w, sn, wa, g, v) => FlowerCell(index = i, neighbours = Map(site -> n), wind = w, water = wa, sun = sn, gravity = g, velocity = v)
  }
  ...
  private def addCellNeighbourNeighbour(c: Cell, n: Cell): Cell = c match {
    ...
    case FlowerCell(i, nei, w, sn, wa, g, v) => FlowerCell(index = i, neighbours = nei ++ n.neighbours, wind = w, water = wa, sun = sn, gravity = g, velocity = v)
  }
  ...
  private def addCellNeighbourNeighbour(site: String , c: Cell, n: Cell): Cell = c match {
    ...
    case FlowerCell(i, nei, w, sn, wa, g, v) => FlowerCell(index = i, neighbours = nei + (site -> n), wind = w, water = wa, sun = sn, gravity = g, velocity = v)
  }
